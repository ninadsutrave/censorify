...
module.exports = {
  object: require('badwords-list/lib/object'),
  array: require('badwords-list/lib/array'),
  regex: require('badwords-list/lib/regexp')
};
},{"badwords-list/lib/array":3,"badwords-list/lib/object":5,"badwords-list/lib/regexp":6}],5:[function(require,module,exports){
...
browser.storage.local.get("radio").then(function (result1) {
    browser.storage.local.get("placeholder").then(function (result2) {
        browser.storage.local.get("toggle").then(function (result3) {
            radio = result1.radio;
